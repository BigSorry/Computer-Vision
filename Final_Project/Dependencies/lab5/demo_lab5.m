...
function F = demo_lab5()
    ...
    % Read images
    disp('Reading images');
    img1 = im2double(rgb2gray(imread('model_castle/8ADT8604.png')));
    img2 = im2double(rgb2gray(imread('model_castle/8ADT8603.png')));
    ...
    [feat1,desc1,~,~] = loadFeatures('model_castle/8ADT8604.png.haraff.sift');
    [feat2,desc2,~,~] = loadFeatures('model_castle/8ADT8603.png.haraff.sift');
